  ...
  if (!product) {
    return (
      <div className="group relative border border-gray-200 dark:border-gray-800 rounded-md p-4">
        <div className="text-sm text-gray-500 dark:text-gray-400">Product data unavailable</div>
      </div>
    )
  }
  ...
  return (
    <div className="group relative" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
      ...
      <div className="relative aspect-[3/4] overflow-hidden bg-gray-100 dark:bg-gray-800">
        ...
        {/* Sale Badge */}
        {product.salePrice && <div className="absolute top-2 left-2 bg-black text-white text-xs px-2 py-1">Sale</div>}
      </div>
      ...
      <div className="mt-4 flex flex-col">
        ...
        <div className="mt-1 flex items-center justify-between">
          <div className="flex items-center gap-2">
            {product.salePrice ? (
              <>
                <span className="text-sm font-medium text-gray-900 dark:text-gray-100">${product.salePrice}</span>
