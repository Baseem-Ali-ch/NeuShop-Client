...
export default function CartItem({ item }: CartItemProps) {
  ...
  return (
    <motion.div
      animate={isRemoving ? { opacity: 0, height: 0, marginBottom: 0 } : { opacity: 1 }}
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1">
          <div className="flex flex-col sm:flex-row sm:justify-between">
            ...
            <div className="mt-2 sm:mt-0 text-lg font-bold text-gray-900 dark:text-white">${item.price.toFixed(2)}</div>
          </div>
          ...
          <div className="mt-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center justify-between sm:justify-end gap-4">
              <div className="text-lg font-bold text-gray-900 dark:text-white">${subtotal.toFixed(2)}</div>
              <button
