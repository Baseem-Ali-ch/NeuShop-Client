...
export default function CustomerManagement() {
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      <CustomerHeader onAddCustomer={openAddModal} onToggleFilters={toggleFilters} isFilterVisible={isFilterVisible} />
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        <div className="w-full lg:w-3/4">
          <CustomerTable onViewDetails={openCustomerDetails} onEditCustomer={openEditModal} />
        </div>
      ...
      {isAddModalOpen && <CustomerFormModal customerId={editCustomerId} onClose={closeModal} />}
    </div>
  )
}
