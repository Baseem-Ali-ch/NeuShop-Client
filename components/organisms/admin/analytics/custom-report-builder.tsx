...
import { GripVertical, LineChart, BarChartIcon, PieChartIcon, Save, Clock, Plus, X } from "lucide-react"
...
export default function CustomReportBuilder() {
  ...
  return (
    <div className="space-y-4">
      <h2 className="text-xl font-semibold tracking-tight">Custom Report Builder</h2>
                ...
                <div className="border rounded-md p-4 h-[300px] flex items-center justify-center bg-gray-50">
                  <div className="text-center">
                    <div className="text-4xl text-gray-300 mb-2">
                      {chartType === "line" ? <LineChart /> : chartType === "bar" ? <BarChartIcon /> : <PieChartIcon />}
                    </div>
