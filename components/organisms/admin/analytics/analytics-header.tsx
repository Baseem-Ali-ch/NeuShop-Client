              ...
              <DropdownMenuContent align="end" className="w-[240px]">
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-auto p-0" align="start">
                    <DatePickerWithRange
                      dateRange={dateRange}
                      onChange={(range) => setDateRange({ ...range, preset: undefined })}
                    />
                  </PopoverContent>
                </Popover>
              </DropdownMenuContent>
                ...
                <PopoverContent className="w-80">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        {["Daily", "Weekly", "Monthly"].map((freq) => (
                          <Button key={freq} variant="outline" className="w-full" size="sm">
                            {freq}
                          </Button>
                        ))}
                      </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <input className="w-full p-2 border rounded-md" placeholder="email@example.com" />
                    </div>
                    <div className="flex justify-end gap-2">
                      <Button variant="outline" onClick={() => setIsScheduleOpen(false)}>
                        Cancel
                      </Button>
                      <Button onClick={() => setIsScheduleOpen(false)}>Schedule</Button>
                    </div>
                  </div>
                </PopoverContent>
              </Popover>
